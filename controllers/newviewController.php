...
class newviewController extends Controller {
    ...
    $getid=$this->model("sqlcommand");
  	$seerow=$getid->seeclick($_GET['id']);      // 取景點資料 
    ...
    $this->view("newview",$result[0],[$array,$array2,$array3,$array4],[$seerow[0],$seerow[1]]); // 到 newview 頁(data1:景點數、data2:圖片景點資料、data3:景點資訊)
	}
